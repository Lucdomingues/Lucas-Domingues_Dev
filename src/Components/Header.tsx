...
export default function Header() {
  ...
  <path fill-rule="evenodd" d="M3 6.75A.75.75 0 013.75 6h16.5a.75.75 0 010 1.5H3.75A.75.75 0 013 6.75zM3 12a.75.75 0 01.75-.75h16.5a.75.75 0 010 1.5H3.75A.75.75 0 013 12zm0 5.25a.75.75 0 01.75-.75h16.5a.75.75 0 010 1.5H3.75a.75.75 0 01-.75-.75z" clip-rule="evenodd" />
        ...
        <div className='hidden fixed top-16 bg-white text-black rounded justify-center fadeIn' id='open'>
          <nav className='p-8'>
            <ul>
            <li className='mb-4 cursor-pointer' onClick={()=> navigation('/')}><span className='font-medium'>Início</span><br /><span className='font-extralight'>Onde tudo começou!</span></li>

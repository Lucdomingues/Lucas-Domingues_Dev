...
export default function GithubPreview() {
  ...
  return (
    <div className="container md:container max-md:mt-16 ml-8 max-md:ml-0">
      ...
      <a href="https://github.com/Lucdomingues" target="_blank"><span className="flex text-white cursor-pointer hover:underline hover:decoration-1 hover:underline-offset-4">Ver Todos<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 ml-1 h-6">

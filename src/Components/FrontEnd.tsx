import frontImage from "../assets/react-removebg-preview.png";

export default function FrontEnd() {
  return (
    <div
      id="front-end"
      className=" flex flex-col justify-around screen bg__sections"
    >
      <div className="flex justify-center mx-5">
        <div className="items-center flex flex-col">
          ...
          />
          <h2 className="text-white text-6xl font-bold mt-6">Front End</h2>
        </div>
      </div>
      <div className="grid grid-cols-4 gap-6 justify-items-center mx-5">
        ...
        <div id="tailwind">
          <svg viewBox="0 0 128 128" className="w-28">
            <defs>
              <linearGradient
